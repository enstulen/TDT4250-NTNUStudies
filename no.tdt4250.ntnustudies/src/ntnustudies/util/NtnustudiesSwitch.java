 ...
 * @generated
 */
public class NtnustudiesSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static NtnustudiesPackage modelPackage;
	 ...
	 * @generated
	 */
	public NtnustudiesSwitch() {
		if (modelPackage == null) {
			modelPackage = NtnustudiesPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case NtnustudiesPackage.CHOSEN_SEMESTER: {
				ChosenSemester chosenSemester = (ChosenSemester)theEObject;
				T result = caseChosenSemester(chosenSemester);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Chosen Semester</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Chosen Semester</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseChosenSemester(ChosenSemester object) {
		return null;
	}
