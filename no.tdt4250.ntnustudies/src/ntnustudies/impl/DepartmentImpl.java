...
public class DepartmentImpl extends MinimalEObjectImpl.Container implements Department {
	...
	protected EClass eStaticClass() {
		return NtnustudiesPackage.Literals.DEPARTMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NtnustudiesPackage.DEPARTMENT__NAME, oldName, name));
	}
	...
	public EList<Course> getCourses() {
		if (courses == null) {
			courses = new EObjectContainmentEList<Course>(Course.class, this, NtnustudiesPackage.DEPARTMENT__COURSES);
		}
		return courses;
	}
	...
	public void setShortName(String newShortName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NtnustudiesPackage.DEPARTMENT__SHORT_NAME, oldShortName, shortName));
	}
