...
import ntnustudies.impl.*;
import ntnustudies.util.*;
import ntnustudies.*;
...
public class Generate extends AbstractAcceleoGenerator {
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(NtnustudiesPackage.class)) {
        	resourceSet.getPackageRegistry().put(NtnustudiesPackage.eNS_URI, NtnustudiesPackage.eINSTANCE);
        }
    ...
    public void registerResourceFactories(ResourceSet resourceSet) {
        ...
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("xmi", new NtnustudiesResourceFactoryImpl());
    }
